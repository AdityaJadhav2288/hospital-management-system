...
export default function AdminAppointmentsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Manage Appointments" description="Track appointment queue and approval status" />
      <Card>
        <CardHeader>
            ...
            <DataTable
              ...
              columns={[
                ...
                { key: "dateTime", header: "Date & Time", render: (value) => formatDateTime(String(value)) },
                {
                  ...
                  header: "Status",
                  render: (value) => (
                    <Badge tone={value === "CONFIRMED" ? "success" : value === "CANCELLED" ? "danger" : "warning"}>
                      {String(value)}
                    </Badge>
                  ),
                },
