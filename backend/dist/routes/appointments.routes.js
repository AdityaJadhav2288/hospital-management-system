...
router.post("/", (0, authorize_1.authorize)(role_1.Role.PATIENT), (0, validate_1.validateBody)(validation_1.bookAppointmentSchema), (0, async_handler_1.asyncHandler)(patient_controller_1.PatientController.bookAppointment));
router.patch("/:id/status", (0, authorize_1.authorize)(role_1.Role.DOCTOR), (0, validate_1.validateBody)(validation_1.updateAppointmentStatusSchema), (0, async_handler_1.asyncHandler)(doctor_controller_1.DoctorController.updateAppointmentStatus));
